...
export default function EditUser({ slide }) {
    console.log(slide)
    ...
    function submit(e) {
        e.preventDefault();
        put(route('slides.update', slide));
    }
    return(
        <>
            <Head title="Редактирование Слайда"/>
            <div className={'w-1/2 mx-auto'}>
                <h1 className={'font-semibold text-center'}>Редактирование слайда</h1>
